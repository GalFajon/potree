...
export class Viewer extends EventDispatcher {
	...
	constructor(domElement, args = {}) {
		...
		try {
			...
			// Gal -> Da lahko preverimo, kdaj smo v street view-u
			this.focusedOn360Image = false;
	...
	fitToScreen(factor = 1, animationDuration = 0) {
		...
		// Gal -> We no longer zoom in on an added pointcloud.
	...
	loadGUI(callback) {
		...
		sidebarContainer.load(new URL(Potree.scriptPath + '/sidebar.html').href, () => {
			...
			imgMenuToggle.classList.add('potree_menu_toggle');
			// Gal -> hide sidebar
			imgMenuToggle.style.display = 'none';
			...
			// GAL -> Odstranil MapView da se izognemo konfliktu z openlayers
