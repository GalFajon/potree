...
export class OrientedImageLoader {
	...
	static async load(cameraParamsPath, imageParamsPath, viewer) {
		...
		function onMouseClickOnOrientedImage(evt) {
		...
		viewer.renderer.domElement.addEventListener('mousemove', onMouseMoveToOrientedImage, false);
		viewer.renderer.domElement.addEventListener('mousedown', onMouseClickOnOrientedImage, false);
